...
#include "ttnn/cpp/ttnn/operations/swin_ops/concat/concat.hpp"
...
using MassagedConcat = data_movement::MassagedOperation<ttnn::Tensor, const std::vector<ttnn::Tensor>&, int, unsigned int>;
using MassagedConcatParams = data_movement::MassagedOperationParams<ttnn::Tensor, const std::vector<ttnn::Tensor>&, int, unsigned int>;
        ...
        MassagedConcatParams {
            ...
            .post_transform = [queue_id](const ttnn::Tensor& output) -> ttnn::Tensor {
                ...
                if (output.get_layout() != ttnn::TILE_LAYOUT) {
                    auto padded = data_movement::pad_to_tile_vol(queue_id,
                                                    output,
                                                    0.0f,
                                                    true,
