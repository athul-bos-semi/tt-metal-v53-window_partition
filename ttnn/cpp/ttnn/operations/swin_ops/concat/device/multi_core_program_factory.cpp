...
#include "ttnn/cpp/ttnn/operations/swin_ops/concat/device/multi_core_program_factory.hpp"

#include <algorithm>
#include <numeric>

#include "ttnn/cpp/ttnn/operations/swin_ops/concat/device/concat_device_operation.hpp"
...
tt_metal::operation::ProgramWithCallbacks s2s_rm_concat_two_tensors_multi_core(
    ...
    tt_metal::KernelHandle unary_reader_kernel_id = tt_metal::CreateKernel(
        program,
        "ttnn/cpp/ttnn/operations/swin_ops/concat/device/kernels/dataflow/"
...
tt_metal::operation::ProgramWithCallbacks s2s_concat_multi_core(
    ...
    tt_metal::KernelHandle unary_reader_kernel_id = tt_metal::CreateKernel(
        program,
        "ttnn/cpp/ttnn/operations/swin_ops/concat/device/kernels/dataflow/reader_s2s_tensor_concat.cpp",
        all_cores,
...
tt_metal::operation::ProgramWithCallbacks s2i_rm_concat_multi_core(
    ...
    tt_metal::KernelHandle unary_reader_kernel_id = tt_metal::CreateKernel(
        program,
        "ttnn/cpp/ttnn/operations/swin_ops/concat/device/kernels/dataflow/reader_s2i_width.cpp",
        all_cores,
        tt_metal::ReaderDataMovementConfig(reader_compile_time_args));

    tt_metal::KernelHandle unary_writer_kernel_id = tt_metal::CreateKernel(
        program,
        "ttnn/cpp/ttnn/operations/swin_ops/concat/device/kernels/dataflow/writer_s2i_width.cpp",
        all_cores,
...
tt_metal::operation::ProgramWithCallbacks concat_multi_core(
    ...
    tt_metal::KernelHandle unary_reader_kernel_id = tt_metal::CreateKernel(
        program,
        rm_layout ? "ttnn/cpp/ttnn/operations/swin_ops/concat/device/kernels/dataflow/"
